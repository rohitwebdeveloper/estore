  ...
  return (
    <>
      <div className="container">
        <Productlist click={[allonclick, tvonclick, refregiratoronclick, washingonclick]} productlistname={['Shirt', 'Trausors & Jeans', 'Sarees & Suits', 'Seasonal Wears', 'Kurtas', 'Accessories', 'Shoes']} />
        ...
        <Filter change={handleonchange} brand={['Raymond', 'Xiaomi', 'Sony', 'LG', 'TCL']}  price={['Upto ₹1000', '₹1000 to ₹2000', '₹2000 to ₹3000', '₹3000 to ₹5000', '₹5000 to ₹8000', '₹8000 to ₹11000', '₹11000 to ₹15000', '₹15000 to ₹20000', '₹20000 to ₹30000', 'Above ₹30000']} />
      </div>
