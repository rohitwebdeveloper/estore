  ...
  return (
    <>
      <div className="container">
        ...
        <Filter change={handleonchange}  brand={['MamaEarth', 'Lakme', 'Nayeka', 'Dermaco', 'Cetafil', 'Patanjali', 'Wecare', 'Ponds']}  price={['Upto ₹100', '₹100 to ₹200', '₹200 to ₹300', '₹300 to ₹400', '₹400 to ₹500', '₹500 to ₹600', '₹600 to ₹800', '₹800 to ₹1000', '₹1000 to ₹1200', 'Above ₹1200']} />
      </div>
